  ...
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        <div className='bg-green-50 p-8:max-w-[500px] xl:max-w-[734px]
        xl:rounded-5xl xl:px-16 xl:py20 relative w-full overflow-hidden
        rounded-3xl'>
          ...
          capitalize text-white'>
            ...
            a new climbing location, the possibility of getting lost is very large. 
